  ...
  const handleToggleStep = async (step: ProcessStep) => {
    ...
    try {
      ...
      if (step.stepName === "Autorizar via sistema" && !step.isCompleted) {
        console.log("🔥 StepChecklist - APROVANDO Autorizar via sistema via botão 'Aprovar etapa'");
                        ...
                        >
                          <Checkbox 
                            ...
                            onCheckedChange={async (checked) => {
                              ...
                              if (step.stepName === "Autorizar via sistema" && !step.isCompleted) {
                                try {
                                  console.log("🔥 Arquivando processo ao aprovar 'Autorizar via sistema' (checkbox)");
